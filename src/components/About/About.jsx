...
const About = () => {
    return (
        <section
            id='about'
            className='py-4 px-[7vw] md:px-[7vw] lg:px-[12vw] font-sans mt-8 md:mt-12 lg:mt-16 bg-[#dab7f1] dark:bg-[#141b2c]'
        >
            <div className="flex flex-col-reverse md:flex-row justify-between items-center">
                <div className="md:w-[85%] text-center md:text-left mt-8 md:mt-0">
                    <h1 className="text-xl sm:text-3xl md:text-3xl font-bold text-[#19161d] dark:text-[#e9d7fe] mb-2 leading-tight">
                        Hello, I am
                    </h1>
                    <h2 className="text-3xl sm:text-5xl md:text-5xl font-bold text-[#5726b9] dark:text-[#c9a4f7] mb-4 leading-tight whitespace-nowrap">
                        Kaushalendra Pratap
                    </h2>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 text-[#5726b9] dark:text-[#74c0fc] leading-tight">
                        I am a{" "}
                    ...
                    <p className='text-base md:text-lg sm:text-base text-[#1f2024] dark:text-[#abb0ca] mb-10 mt-8 leading-relaxed max-w-[90%] sm:max-w-[100%] md:max-w-[36rem] lg:max-w-[40rem] mx-auto px-4'>
                    ...
                    <a
                        ...
                        className='inline-block text-[#f6f0fa] dark:text-[#141b2c] py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105 border-2 border-amber-950'
                        style={{
                ...
                <div className='md:w-1/2 flex justify-center md:justify-end mt-10 md:ml-8 md:mt-4'>
                    <Tilt
                        className='w-48 h-48 sm:w-72 sm:h-72 md:w-[26rem] md:h-[26rem] border-4 border-[#8245ec] dark:border-[#4fc3f7] bg-[#e5e0ff] dark:bg-[#222741] rounded-full'
                        tiltMaxAngleX={20}
                        tiltMaxAngleY={20}
                        perspective={1000}
                        scale={1.05}
